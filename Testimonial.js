...
import TestimonialCss from "../assets/css/testimonial.css";
      ...
      <div className="home-learners-path-div heading">
        ...
        <div className="test-heading">
          <p className="font-one-rem text-center in test-head">
            ...
            impact of our programs on their professional lives
          </p>
        </div>
      </div>
          ...
          <div className=" swiper-wrapper swiper">
              ...
              <div className="testimonial-card">
                ...
                <div className="container text-center">
                  <div className="row pad">
                    ...
                    <div className="NAME">
                      <h5 className="text-left test-name  ">
                        <b> Hritwij Shrivastava</b>
                      </h5>
                      <h5 className="text-left sepcialist">ML Developer</h5>
                    </div>
                  </div>
                </div>
                <div className="" id="testimonial-text">
                  <span className="">
                    ...
                    me at every stage. I became extremely confident in ML after
                    successfully completing the MIT assignments.
                  </span>
                </div>
              ...
              <div className="testimonial-card">
                ...
                <div className="container text-center">
                  <div className="row pad">
                    ...
                    <div className="NAME">
                      ...
                      <h5 className="text-left sepcialist">
                ...
                <div className="" id="testimonial-text">
                  <span className="">
                    ...
                    India, they all are missing the personal touch that the team
                    at Hero Vired team provides.
                  </span>
                </div>
                ...
                <div className="container text-center">
                  <div className="row pad">
                    ...
                    <div className="NAME">
                      ...
                      <h5 className="text-left sepcialist">Risk Analyst</h5>
                    </div>
                  </div>
                </div>
                <div className="" id="testimonial-text">
                  <span className="">
                    ...
                    my career trajectory. I come from an engineering background
                    so making a move to the Finance field was not the easiest.
                    The faculty made sure that this transition was smooth.
                  </span>
                </div>
                ...
                <div className="container text-center">
                  <div className="row pad">
                    ...
                    <div className="NAME">
                      ...
                      <h5 className="text-left sepcialist">Desgine Engineer</h5>
                    </div>
                  </div>
                </div>
                <div className="" id="testimonial-text">
                  <span className="">
                    I was impressed by the concepts, presentation skills, & case
                    analysis approach. During face-to-face lectures &
              ...
              <div className="testimonial-card">
                ...
                <div className="" id="testimonial-text">
                  <span className="">
                    ...
                    for the fact that it has honed my practical understanding of
                    all the concepts.
                  </span>
                </div>
            ...
            <div className="test-card">
              <div className="testimonial-card">
                ...
                <div className="" id="testimonial-text">
                  <span className="">
                    The dedication shown by the entire team in ensuring that the
                    learning process is smooth & fruitful is amazing. The
              ...
              <div className="testimonial-card">
                ...
                <div className="container text-center">
                  <div className="row pad">
                    ...
                    <div className="NAME">
                      <h5 className="text-left test-name  ">
                        <b>Balraj Singh Bhullar</b>
                      </h5>
                      <h5 className="text-left sepcialist">Web Developer</h5>
                    </div>
                  </div>
                </div>
                <div className="" id="testimonial-text">
                  <span className="">
                    I am glad I joined a Hero Vired program. The team support is
                    second to none. With the help of Hero Vired, I was able to
                    start learning online and build up the knowledge and skills
                    that would help me in building up my career.
                  </span>
                </div>
